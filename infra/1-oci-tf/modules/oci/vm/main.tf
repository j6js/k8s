...
resource "oci_core_instance" "vm" {
  ...
  lifecycle {
    ignore_changes = [
      # Ignore changes to the image_id to prevent instance replacement when the image is updated
      # See ./config.yaml lines 2-6 for how to update existing instances
